...
public class ThreadGetRestaurantBookingTimeAvailable extends AsyncTask<Void, Void, String> {
...
//    ListView menuListView = null;
    ...
    public ThreadGetRestaurantBookingTimeAvailable(Context context, Bundle intentData) {
