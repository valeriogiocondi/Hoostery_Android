...
public class ArrayListAdapterBookingsHistory extends ArrayAdapter<String[]> {

    Context parentContext = null;

    public ArrayListAdapterBookingsHistory(Context context, ArrayList<String[]> List)  {

        super(context, R.layout.activity_main_left_menu_voice_bookings_history, List);
