...
import com.hoostery.user.hoostery.Search.ActivitySearchLeftMenu.ArrayAdapterFavoritesList;
...
public class ThreadGetFavoritesList extends AsyncTask<Void, Void, String> {

    private ListView favoritesListView;
    private Activity activity;
    Context parentContext = null;

    public ThreadGetFavoritesList(Context context, ListView list){

        parentContext = context;
        activity = (Activity) context;
        favoritesListView = list;
    }
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            ArrayAdapterFavoritesList restaurantsAdapter = new ArrayAdapterFavoritesList(parentContext, list);
            favoritesListView.setAdapter(restaurantsAdapter);
