...
public class ThreadGetBookingsHistory extends AsyncTask<Void, Void, String> {

    private ListView bookingsHistoryListView;
    private Activity activity;
    Context parentContext = null;

    public ThreadGetBookingsHistory(Context context, ListView list){

        parentContext = context;
        activity = (Activity) context;
        bookingsHistoryListView = list;
    }
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            ArrayListAdapterBookingsHistory restaurantsAdapter = new ArrayListAdapterBookingsHistory(parentContext, list);
            bookingsHistoryListView.setAdapter(restaurantsAdapter);
        ...
        bookingsHistoryListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
